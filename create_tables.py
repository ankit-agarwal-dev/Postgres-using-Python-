...
This script is used to intialise sparkifydb Database. It first drop 
and recreate the sparkifydb and then create required facts and 
dimensions.
...
def create_database():
    """Creating sparkifydb Database.If DB already exist then drop & recreate. 
